var GRAHA = {}, $ = jQuery.noConflict(); (function ($) {
    "use strict"; var $window = $(window), $theme_color = '#2250fc', $body = $('body'), $bodyInner = $('.body-inner'), $section = $('section'), $topbar = $('#topbar'), $header = $('#header'), $headerCurrentClasses = $header.attr('class'), headerLogo = $('#logo'), $mainMenu = $('#mainMenu'), $pageMenu = $('.page-menu'), $slider = $('#slider'), $grahaSlider = $('.graha-slider'), $carousel = $('.carousel'), $gridLayout = $(".grid-layout"), $gridFilter = $(".grid-filter"), windowWidth = $window.width(); if ($gridFilter.length > 0) { $gridFilter = $gridFilter; } else { $gridFilter = $(".page-grid-filter"); }
    ...
    $(window).breakpoints({ breakpoints: [{ "name": "xs", "width": 0 }, { "name": "sm", "width": 576 }, { "name": "md", "width": 768 }, { "name": "lg", "width": 992 }, { "name": "xl", "width": 1200 }] }); var currentBreakpoint = $(window).breakpoints("getBreakpoint"); $body.addClass('breakpoint-' + currentBreakpoint); $(window).bind("breakpoint-change", function (breakpoint) { $body.removeClass('breakpoint-' + breakpoint.from); $body.addClass('breakpoint-' + breakpoint.to); }); $(window).breakpoints("greaterEqualTo", "lg", function () { $body.addClass('b--desktop'); $body.removeClass('b--responsive'); }); $(window).breakpoints("lessThan", "lg", function () { $body.removeClass('b--desktop'); $body.addClass('b--responsive'); }); GRAHA.core = {
        functions: function () { GRAHA.core.scrollTop(); GRAHA.core.rtlStatus(); GRAHA.core.rtlStatusActivate(); GRAHA.core.equalize(); GRAHA.core.customHeight(); }, scrollTop: function () {
        ...
        functions: function () { GRAHA.header.logoStatus(); GRAHA.header.stickyHeader(); GRAHA.header.topBar(); GRAHA.header.search(); GRAHA.header.mainMenu(); GRAHA.header.mainMenuOverlay(); GRAHA.header.pageMenu(); GRAHA.header.sidebarOverlay(); GRAHA.header.dotsMenu(); GRAHA.header.onepageMenu(); }, logoStatus: function (status) {
            var headerLogoDefault = headerLogo.find($('.logo-default')), headerLogoDark = headerLogo.find($('.logo-dark')), headerLogoFixed = headerLogo.find('.logo-fixed'), headerLogoResponsive = headerLogo.find('.logo-responsive'); if ($header.hasClass("header-sticky") && headerLogoFixed.length > 0) { headerLogoDefault.css("display", "none"); headerLogoDark.css("display", "none"); headerLogoResponsive.css("display", "none"); headerLogoFixed.css("display", "block"); } else {
                ...
                if (!$header.is(".header-disable-fixed")) {
                    if (scrollOnTop > $headerOffsetTop + shrinkHeader) {
                        $header.addClass('header-sticky'); if (scrollOnTop > $headerOffsetTop + shrinkHeaderActive) {
                            ...
                            GRAHA.header.logoStatus();
                        }
                    } else { $header.removeClass().addClass($headerCurrentClasses); GRAHA.header.logoStatus(); }
                }
                    ...
                    var elem = $(this); e.preventDefault(); $(window).breakpoints("lessThan", "lg", function () {
                        var openMenu = function () {
                            if (!processing) {
                                ...
                                elem.addClass('toggle-active'); $body.addClass('mainMenu-open'); GRAHA.header.logoStatus(); $mainMenu.animate({ 'min-height': $window.height() }, { duration: 500, easing: "easeInOutQuart", start: function () { setTimeout(function () { $mainMenu.addClass('menu-animate'); }, 300); }, complete: function () { processing = false; } });
                            }
                        }; var closeMenu = function () { if (!processing) { processing = true; Settings.menuIsOpen = false; GRAHA.header.logoStatus(); $mainMenu.animate({ 'min-height': 0 }, { start: function () { $mainMenu.removeClass('menu-animate'); }, done: function () { $body.removeClass('mainMenu-open'); elem.removeClass('toggle-active'); if (Settings.submenuLight && darkClassRemoved) { $header.addClass('dark'); } }, duration: 500, easing: "easeInOutQuart", complete: function () { processing = false; } }); } }; if (!Settings.menuIsOpen) { triggerEvent = openMenu(); } else { triggerEvent = closeMenu(); }
                    });
        ...
        functions: function () { GRAHA.slider.grahaSlider(); GRAHA.slider.carousel(); }, grahaSlider: function () {
            if ($grahaSlider.length > 0) {
                ...
                $grahaSlider.each(function () {
                    var elem = $(this); elem.options = { cellSelector: elem.attr('data-item') || false, prevNextButtons: elem.data('arrows') == false ? false : true, pageDots: elem.data('dots') == false ? false : true, fade: elem.data('fade') == true ? true : false, draggable: elem.data('drag') == true ? true : false, freeScroll: elem.data('free-scroll') == true ? true : false, wrapAround: elem.data('loop') == false ? false : true, groupCells: elem.data('group-cells') == true ? true : false, autoPlay: elem.attr('data-autoplay') || 8000, pauseAutoPlayOnHover: elem.data('hoverpause') == false ? false : true, adaptiveHeight: elem.data('adaptive-height') == false ? false : false, asNavFor: elem.attr('data-navigation') || false, selectedAttraction: elem.attr('data-attraction') || .07, friction: elem.attr('data-friction') || .9, initialIndex: elem.attr('data-initial-index') || 0, accessibility: elem.data('accessibility') == true ? true : false, setGallerySize: elem.data('gallery-size') == false ? false : false, resize: elem.data('resize') == false ? false : false, cellAlign: elem.attr('data-align') || 'left', }; elem.find('.slide').each(function () {
        ...
        functions: function () { GRAHA.elements.naTo(); GRAHA.elements.morphext(); GRAHA.elements.buttons(); GRAHA.elements.accordion(); GRAHA.elements.animations(); GRAHA.elements.parallax(); GRAHA.elements.backgroundImage(); GRAHA.elements.shapeDivider(); GRAHA.elements.responsiveVideos(); GRAHA.elements.counters(); GRAHA.elements.countdownTimer(); GRAHA.elements.progressBar(); GRAHA.elements.pieChart(); GRAHA.elements.maps(); GRAHA.elements.gridLayout(); GRAHA.elements.tooltip(); GRAHA.elements.popover(); GRAHA.elements.magnificPopup(); GRAHA.elements.yTPlayer(); GRAHA.elements.vimeoPlayer(); GRAHA.elements.modal(); GRAHA.elements.sidebarFixed(); GRAHA.elements.clipboard(); GRAHA.elements.bootstrapSwitch(); GRAHA.elements.countdown(); GRAHA.elements.other(); GRAHA.elements.videoBackground(); GRAHA.elements.forms(); GRAHA.elements.formValidation(); GRAHA.elements.formAjaxProcessing(); GRAHA.elements.wizard(); }, forms: function () { var $showHidePassword = $('.show-hide-password'); if ($showHidePassword.length > 0) { $showHidePassword.each(function () { var elem = $(this), $iconEye = 'icon-eye11', $iconClosedEye = 'icon-eye-off', elemShowHideIcon = elem.find('.input-group-append i'), elemInput = elem.children('input'); elem.find('.input-group-append i').css({ 'cursor': 'pointer' }); elemShowHideIcon.on('click', function (event) { event.preventDefault(); if (elem.children('input').attr("type") == "text") { elemInput.attr('type', 'password'); elemShowHideIcon.removeClass($iconEye); elemShowHideIcon.addClass($iconClosedEye); } else if (elem.children('input').attr("type") == "password") { elemInput.attr('type', 'text'); elemShowHideIcon.addClass($iconEye); elemShowHideIcon.removeClass($iconClosedEye); } }); }) } }, formValidation: function () {
            ...
            var $textRotator = $('.text-rotator'); if ($textRotator.length > 0) {
                if (typeof $.fn.Morphext === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery Morphext plugin is missing in plugins.js file.", "danger")
                    return true;
                }
                $textRotator.each(function () {
                    var elem = $(this); elem.options = { animation: elem.attr('data-animation') || "fadeIn", separator: elem.attr('data-separator') || ",", speed: elem.attr('data-speed') || 2000, height: elem.height() }
                    elem.css({ 'min-height': elem.options.height }); elem.Morphext({ animation: elem.options.animation, separator: elem.options.separator, speed: Number(elem.options.speed) });
                });
            }
        }, buttons: function () {
            ...
            var $animate = $("[data-animate]"); if ($animate.length > 0) {
                if (typeof Waypoint === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery Waypoint plugin is missing in plugins.js file.", "danger")
                    return true;
                }
            ...
            var $parallax = $('[data-bg-parallax]'); if ($parallax.length > 0) {
                if (typeof $.fn.scrolly === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery scrolly plugin is missing in plugins.js file.", "danger")
                    return true;
                }
            ...
            var $shape_divider = $(".shape-divider"); $shape_divider.each(function () {
                var elem = $(this); elem.options = { style: elem.attr('data-style') || 1, color: elem.attr('data-color') || '#ffffff', opacity: elem.attr('data-opacity') || '1', zIndex: elem.attr('data-zIndex') || '0', height: elem.attr('data-height') || 210, prefix: "PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCA2MzAg" }
            ...
            var $counter = $('.counter'); if ($counter.length > 0) {
                if (typeof $.fn.countTo === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery countTo plugin is missing in plugins.js file.", "danger")
                    return true;
                }
                $counter.each(function () { var elem = $(this), prefix = elem.find("span").attr("data-prefix") || "", suffix = elem.find("span").attr("data-suffix") || ""; new Waypoint({ element: elem, handler: function () { elem.find('span').countTo({ refreshInterval: 2, formatter: function (value, options) { return String(prefix) + value.toFixed(options.decimals) + String(suffix); }, }); this.destroy(); }, offset: '104%' }); });
            }
        }, countdownTimer: function () {
            var $countdownTimer = $('.countdown'); if ($countdownTimer.length > 0) {
                if (typeof $.fn.countdown === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery countdown plugin is missing in plugins.js file.", "danger")
                    return true;
                }
                $('[data-countdown]').each(function () { var $this = $(this), finalDate = $(this).attr('data-countdown'); $this.countdown(finalDate, function (event) { $this.html(event.strftime('<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>Day%!d</span></div>' + '<div class="countdown-box"><div class="number">%H</div><span>Hours</span></div>' + '<div class="countdown-box"><div class="number">%M</div><span>Minutes</span></div>' + '<div class="countdown-box"><div class="number">%S</div><span>Seconds</span></div></div>')); }); });
            }
            ...
            var $map = $('.map'); if ($map.length > 0) {
                if (typeof $.fn.gmap3 === 'undefined') {
                    GRAHA.elements.notification("Warning", "Error", "danger")
                    return true;
                }
                $map.each(function () {
                    var elem = $(this); elem.options = { latitude: elem.attr('data-latitude') || "-37.817240", longitude: elem.attr('data-longitude') || "144.955820", info: elem.attr('data-info'), maptype: elem.attr('data-type') || "ROADMAP", zoom: elem.attr('data-zoom') || 14, icon: elem.attr('data-icon'), mapColor: elem.attr('data-style') || null, }
            ...
            if ($gridLayout.length > 0) {
                if (typeof $.fn.isotope === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery isotope plugin is missing in plugins.js file.", "danger")
                    return true;
                }
                var isotopeRTL; if (GRAHA.core.rtlStatus()) { isotopeRTL = false; } else { isotopeRTL = true; }
            ...
            if (typeof $.fn.infiniteScroll === 'undefined') { GRAHA.elements.notification("Warning", "jQuery infiniteScroll plugin is missing, please add this code line <b> &lt;script src=&quot;plugins/metafizzy/infinite-scroll.min.js&quot;&gt;&lt;/script&gt;</b>, before <b>plugins.js</b>", "danger"); return true; }
            ...
            elem.on('append.infiniteScroll', function (event, response, path, items) { GRAHA.slider.carousel($(items).find('.carousel')); loadMoreBtn.html(loadMoreBtnText); element.css("margin", "0 -" + gridMargin + "px -" + gridMargin + "px 0"); element.find('.' + gridItem).css("padding", "0 " + gridMargin + "px " + gridMargin + "px 0"); });
        }, tooltip: function () {
            var $tooltip = $('[data-toggle="tooltip"]'); if ($tooltip.length > 0) {
                if (typeof $.fn.tooltip === 'undefined') {
                    GRAHA.elements.notification("Warning: jQuery tooltip plugin is missing in plugins.js file.", "warning")
                    return true;
                }
                $tooltip.tooltip();
            }
            ...
            var $popover = $('[data-toggle="popover"]'); if ($popover.length > 0) {
                if (typeof $.fn.popover === 'undefined') {
                    GRAHA.elements.notification("Warning: jQuery popover plugin is missing in plugins.js file.", "warning")
                    return true;
                }
            ...
            var $ytPlayer = $('.youtube-background'); if ($ytPlayer.length > 0) {
                if (typeof $.fn.YTPlayer === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery YTPlayer plugin is missing, please add this code line <b> &lt;script src=&quot;plugins/youtube-player/jquery.mb.YTPlayer.min.js&quot;&gt;&lt;/script&gt;</b>, before <b><--Template functions--></b>", "danger", 10000)
                    return true;
                }
            ...
            var $vmPlayer = $('.vimeo-background'); if ($vmPlayer.length > 0) {
                if (typeof $.fn.vimeo_player === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery vimeo_player plugin is missing, please add this code line <b> &lt;script src=&quot;plugins/vimeo-player/jquery.mb.vimeo_player.min.js&quot;&gt;&lt;/script&gt;</b>, before <b><--Template functions--></b>", "danger", 10000)
                    return true;
                }
            ...
            $element = 'body'; var notify = function () {
                $.notify({ title: $title, message: $message }, {
                    element: $element, type: $type || 'warning', delay: $delay || 10000, template: '<div data-notify="container" ' + $backgroundImageContainer + ' class="bootstrap-notify ' + $elementContainer + ' alert alert-{0}" role="alert">' +
            ...
            if (GRAHA.core.rtlStatus()) { return true; }
            var $sidebarFixed = $('.sticky-sidebar'); if ($sidebarFixed.length > 0) {
                if (typeof $.fn.theiaStickySidebar === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery theiaStickySidebar plugin is missing in plugins.js file.", "danger")
                    return true;
                }
                $sidebarFixed.each(function () {
                    ...
                    elem.theiaStickySidebar({ additionalMarginTop: Number(elem.options.additionalMarginTop), additionalMarginBottom: Number(elem.options.additionalMarginBottom), disableOnResponsiveLayouts: true });
                });
            }
        }, bootstrapSwitch: function () {
            var $bootstrapSwitch = $('[data-switch=true]'); if ($bootstrapSwitch.length > 0) {
                if (typeof $.fn.bootstrapSwitch === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery bootstrapSwitch plugin is missing in plugins.js file.", "danger")
                    return true;
                }
            ...
            var $clipboardTarget = $('[data-clipboard-target]'), $clipboardText = $('[data-clipboard-text]'); if ($clipboardTarget.length > 0) {
                if (typeof ClipboardJS === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery ClipboardJS plugin is missing in plugins.js file.", "danger")
                    return true;
                }
        ...
        functions: function () { GRAHA.widgets.twitter(); GRAHA.widgets.flickr(); GRAHA.widgets.instagram(); GRAHA.widgets.instagramComplete(); GRAHA.widgets.subscribeForm(); }, twitter: function () {
            var $widget_twitter = $('.widget-tweeter') || $('.widget-twitter'); if ($widget_twitter.length > 0) {
                if (typeof $.fn.twittie === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery twittie plugin is missing in plugins.js file.", "danger")
                    return true;
                }
                var t = setTimeout(function () {
                    $widget_twitter.each(function () {
                        ...
                        $elem.find('#twitter-cnt').twittie({ 'username': twitterUsername, 'count': twitterLimit, 'dateFormat': twitterDateFormat, 'template': twitterAvatar + '{{tweet}}<small>{{date}}</small>', 'apiPath': twitterApiPAth, 'loadingText': twitterLoadingText }); if ($elem.closest('.grid-item').length) { GRAHA.elements.gridLayoutRefresh(); }
                    });
                }, 2000);
            }
        }, flickr: function () {
            var $flickr_widget = $('.flickr-widget'); if ($flickr_widget.length > 0) {
                if (typeof $.fn.jflickrfeed === 'undefined') {
                    GRAHA.elements.notification("Warning", "jQuery jflickrfeed plugin is missing in plugins.js file.", "danger")
                    return true;
                }
