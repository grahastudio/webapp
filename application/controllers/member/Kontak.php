...
class Kontak extends CI_Controller{
  ...
  public function lihat($id_kontak)
  {
    ...
    $data = array('title'             => 'View Data Pesan Masuk',
                  'kontak'       => $kontak,
                  'id_kontak'    => $id_kontak,
                  'isi'               => 'member/kontak/lihat'
     );
     $this->load->view('member/layout/wrapper', $data, FALSE);
        ...
        public function delete($id_kontak)
        {
          ...
          redirect(base_url('member/kontak'), 'refresh');
        }
...
/* Location /application/controller/member/Pendaftaran.php */
