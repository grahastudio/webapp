...
class Rekening extends CI_Controller{
  ...
  public function index()
  {
    ...
    //Validasi
    $this->form_validation->set_rules('nomor_rekening','Nomor','required|is_unique[rekening.nomor_rekening]',
    ...
    $data = array('title'             => 'Data rekening ('.count($rekening).')',
                  'rekening'          => $rekening,
                  'isi'               => 'member/rekening/listrekening'
     );
    ...
    redirect(base_url('member/rekening'), 'refresh');
   }
    //End Masuk Database
  }
  ...
  public function edit($id_rekening)
  {
    ...
    $data = array('title'             => 'Edit rekening Berita',
                  'rekening'          => $rekening,
                  'isi'               => 'member/rekening/edit'
     );
     $this->load->view('member/layout/wrapper', $data, FALSE);
     //Masuk Database
   }else {
...
/* Location /application/controller/member/Rekening.php */
