  ...
  public function tambah()
  {
   ...
   if($valid->run()){
    ...
    $data = array( 'title'                     => 'Tambah Galeri',
                ...
                redirect(base_url('member/galeri'), 'refresh');
  ...
  public function ubahtopimage($id_galeri)
  {
    $galeri = $this->galeri_model->detail($id_galeri);
     ...
     if($valid->run()){
       ...
       //End Validasi
      $data = array( 'title'        => 'Edit Top Image',
                     'galeri'       => $galeri,
                     'error_upload' => $this->upload->display_errors(),
                     'isi'          => 'member/galeri/topimage'
                   );
                  ...
                  $this->galeri_model->edit($data);
                  $this->session->set_flashdata('sukses','Data telah Diedit');
                  redirect(base_url('member/galeri/topimage'), 'refresh');
                 ...
                 $data = array( 'title'        => 'Edit Top Image',
                                'galeri'       => $galeri,
                                'isi'          => 'member/galeri/ubahtopimage'
                              );
                 $this->load->view('member/layout/wrapper', $data, FALSE);
  }
...
/* Location /application/controller/member/Galeri.php */
