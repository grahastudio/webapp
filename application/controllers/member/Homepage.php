...
class Homepage extends CI_Controller{
  ...
  public function index()
  {
    ...
    $data = array( 'title'      => 'Data Homepage ('.count($homepage).')',
                   'homepage'    => $homepage,
                   'section'    => $section,
                   'isi'        => 'member/homepage/listhomepage'
                 );
  ...
  public function tambah()
  {
   ...
   $valid->set_rules('judul_homepage','Judul Homepage','required',
   ...
   if($valid->run()){
     ...
     //End Validasi
    $data = array( 'title'                     => 'Tambah Homepage',
                   'error_upload'              => $this->upload->display_errors(),
                   'isi'                       => 'member/homepage/tambah'
                 );
                 $this->load->view('member/layout/wrapper', $data, FALSE);
                ...
                redirect(base_url('member/homepage'), 'refresh');
  ...
  public function tambah_section(){
    ...
    //Validasi
    $this->form_validation->set_rules('judul_homepage','Judul','required|is_unique[page.judul_page]',
            array ('required'         => '%s Harus Diisi',
                                        ));
    ...
    $data = array('title'             => 'Tambah Section',
                  'isi'               => 'member/homepage/tambahsection'
     );
     $this->load->view('member/layout/wrapper', $data, FALSE);
     //Masuk Database
   }else {
  ...
  public function editsection($id_homepage)
  {
    ...
    $data = array(
                  ...
                  'title'             => 'Edit Section',
                  'homepage'          => $homepage,
                  'isi'               => 'member/homepage/editsection'
     );
     $this->load->view('member/layout/wrapper', $data, FALSE);
     //Masuk Database
   }else {
  ...
  public function edit($id_homepage)
  {
    $homepage = $this->homepage_model->detail($id_homepage);
     ...
     if($valid->run()){
       ...
       //End Validasi
      $data = array( 'title'        => 'Edit Homepage',
                     'homepage'       => $homepage,
                     'error_upload' => $this->upload->display_errors(),
                     'isi'          => 'member/homepage/edit'
                   );
                   $this->load->view('member/layout/wrapper', $data, FALSE);
                   ...
                   $data  = array(   'id_homepage'        => $id_homepage,
                                     'id_user'          => $this->session->userdata('id_user'),
                                     'judul_homepage'     => $i->post('judul_homepage'),
                                     'isi_homepage'       => $i->post('isi_homepage'),
                                     'url'          => $i->post('url'),
...
/* Location /application/controller/member/Homepage.php */
