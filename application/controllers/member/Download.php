...
class Download extends CI_Controller{
  ...
  public function index()
  {
    ...
    $data = array( 'title'    => 'Data Artikel ('.count($download).')',
                   'download'   => $download,
                   'isi'      => 'member/download/listdownload'
                 );
  ...
  $kategori = $this->kategori_model->get_all();
    ...
    //Validasi
   $this->form_validation->set_rules('judul_download','Judul Download','required',
                       array( 'required'      => '%s harus diisi'));

   $this->form_validation->set_rules('deskripsi','Deskripsi  Download','required',
                       array( 'required'      => '%s harus diisi'));
   ...
   if($this->form_validation->run() === FALSE){
    ...
    $data = array( 'title'        => 'Tambah Download',
                ...
                redirect(base_url('member/download'), 'refresh');
  ...
  public function edit($id_download)
  {
    ...
    $kategori = $this->kategori_model->get_all();
     ...
     $valid->set_rules('judul_download','Judul Download','required',
                         array( 'required'      => '%s harus diisi'));

     $valid->set_rules('deskripsi','Deskripsi Download','required',
                         array( 'required'      => '%s harus diisi'));
...
/* Location /application/controller/member/Download.php */
