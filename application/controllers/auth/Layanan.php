  ...
  public function tambah()
  {
    ...
    if ($valid->run()) {
      ...
      if (!$this->upload->do_upload('gambar')) {
        ...
        redirect(base_url('auth/layanan'), 'refresh');
      }
    }
    //End Masuk Database
    $data = array(
...
/* Location /application/controller/auth/Layanan.php */
