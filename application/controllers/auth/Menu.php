...
class Menu extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->form_validation->set_rules(
      'nama_menu',
      'Nama_Menu',
      'required|is_unique[menu.nama_menu]',
      array(
    ...
    if ($this->form_validation->run() === FALSE) {
      ...
      $data = array(
        'title'             => 'Data menu (' . count($menu) . ')',
        'menu'              => $menu,
        'isi'               => 'auth/menu/listmenu'
      );
      ...
      $data  = array(
        ...
        'nama_menu_en' => $i->post('nama_menu_en'),
        'url'          => $i->post('url'),
      ...
      redirect(base_url('auth/menu'), 'refresh');
    }
    //End Masuk Database
  }
...
/* Location /application/controller/auth/Menu.php */
