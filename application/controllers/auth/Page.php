...
class Page extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data = array(
      'header'  => 'Halaman',
      'title'    => 'Data Halaman (' . count($page) . ')',
      'page'   => $page,
      'isi'      => 'auth/page/listpage'
    );
  ...
  public function tambah()
  {
    ...
    if ($this->form_validation->run() === FALSE) {
      ...
      redirect(base_url('auth/page'), 'refresh');
    }
    //End Masuk Database
...
/* Location /application/controller/auth/Page.php */
