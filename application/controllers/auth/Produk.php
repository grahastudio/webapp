...
class Produk extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data = array(
      'title'    => 'Data Produk (' . count($produk) . ')',
      'produk'   => $produk,
      'isi'      => 'auth/produk/listproduk'
    );
  ...
  public function tambah()
  {
    ...
    if ($valid->run()) {
      ...
      if (!$this->upload->do_upload('gambar')) {
        ...
        redirect(base_url('auth/produk'), 'refresh');
      }
    }
    //End Masuk Database
    $data = array(
...
/* Location /application/controller/auth/Produk.php */
