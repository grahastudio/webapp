...
$attribut = '';
// Form Open
echo form_open_multipart(base_url('auth/produk/edit/' . $produk->id_produk), $attribut);
?>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="form-group form-group-lg">
          ...
          <input type="text" name="judul_produk" class="form-control" placeholder="Judul Produk" value="<?php echo $produk->nama_produk ?>" required>
        </div>

        <div class="form-group">
          <label>Isi Produk</label>
          <textarea name="isi_produk" class="form-control tinymce" placeholder="Isi Produk"><?php echo $produk->deskripsi ?></textarea>
        </div>
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <img src="<?php echo base_url('assets/upload/image/thumbs/' . $produk->gambar) ?>" width="70%" class="img img-thumbnail">
