      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="updateprofile">
          <p>
            ...
            // Form Open
            echo form_open_multipart(base_url('auth/profile'));
            ?>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="custom-controls-stacked">
                    ...
                    <label class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" name="foto_user" value="2.jpg" <?php if ($user->foto_user == "2.jpg") {
                                                                                                        echo "checked";
                                                                                                      } ?>>
                      <span class="custom-control-label"><img class="avatar avatar-xl" src="<?php echo base_url('assets/upload/image/avatar/2.jpg') ?>"></span>
                    </label>
                    <label class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" name="foto_user" value="3.jpg" <?php if ($user->foto_user == "3.jpg") {
                                                                                                        echo "checked";
                                                                                                      } ?>>
                      <span class="custom-control-label"><img class="avatar avatar-xl" src="<?php echo base_url('assets/upload/image/avatar/3.jpg') ?>"></span>
                    </label>
                    <label class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" name="foto_user" value="4.jpg" <?php if ($user->foto_user == "4.jpg") {
                                                                                                        echo "checked";
                                                                                                      } ?>>
