<button type="button" class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#Tambah">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        //Form Open
        echo form_open(base_url('auth/menu'), $attribut);
        ?>

        <div class="form-group">
          <label>Nama Menu ID</label>
          <input type="text" class="form-control" name="nama_menu" placeholder="Nama Menu" required="required">
        </div>

        <div class="form-group">
          <label>Nama Menu EN</label>
          <input type="text" class="form-control" name="nama_menu_en" placeholder="Nama Menu English" required="required">
        </div>
        ...
        <div class="form-group">
          <label>Link/Url</label>
          <input type="text" class="form-control" name="urutan" placeholder="Urutan" required="required">
        </div>
