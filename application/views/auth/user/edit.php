<div class="card">
  ...
  <div class="card-body">
    ...
    // Form Open
    echo form_open_multipart(base_url('auth/user/edit/' . $user->id_user), $attribut);
    ?>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <select name="akses_level" class="form-control custom-select">
            ...
            <option value="Member" <?php if ($user->akses_level == "Member") {
                                      echo "selected";
                                    } ?>>Member</option>
          </select>
        </div>
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <img src="<?php echo base_url('assets/upload/image/avatar/' . $user->foto_user) ?>" width="15%" class="img img-thumbnail">
