<div class="card">
  ...
  <div class="card-body">
    ...
    $attribut = '';
    // Form Open
    echo form_open_multipart(base_url('auth/homepage/edit/' . $homepage->id_homepage), $attribut);
    ?>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <input type="hidden" name="posisi" class="form-control" placeholder="Judul Homepage" value="Welcome">
  ...
  <?php echo $homepage->isi_homepage ?>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <img src="<?php echo base_url('assets/upload/image/' . $homepage->gambar) ?>" class="img img-thumbnail">
        </div>
      </div>
