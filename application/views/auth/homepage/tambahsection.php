<div class="card">
  ...
  <div class="card-body">
    ...
    $attribut = '';
    // Form Open
    echo form_open_multipart(base_url('auth/homepage/tambah_section'), $attribut);
    ?>
      ...
      <div class="col-md-3">
        <div class="form-group form-group-lg" style="font-family:'FontAwesome','Tahoma';">
          ...
          <select name="icon" class="form-control custom-select">
            ...
            <option value="far fa-lightbulb">&#xf0eb; lightbulb</option>
            <option value="fe fe-film"><i class="fe fe-film"></i> Film</option>
