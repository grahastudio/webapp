...
<div class="card">
  ...
  $attribut = '';
  // Form Open
  echo form_open(base_url('member/download/edit/'.$download->id_download),$attribut);
  ?>
...
<div class="col-md-8">
  <div class="form-group form-group-lg">
    ...
    <input type="text" name="judul_download" class="form-control" placeholder="Judul Download"
    value="<?php echo $download->judul_download ?>">
  </div>

  <div class="form-group">
    <label>Isi Download</label>
    <textarea name="deskripsi" class="form-control tinymce" placeholder="Isi Download">
...
<div class="tile col-md-4">
  ...
  <div class="form-group form-group-lg">
    ...
    <input type="text" name="url_download" class="form-control" placeholder="Url Download"
    value="<?php echo $download->url_download ?>">
  </div>
  ...
  <div class="form-group form-group-lg">
    ...
    <select name="status_download" class="form-control custom-select">
      ...
      <option value="Draft" <?php if($download->status_download=="Draft"){echo "selected";}?> >Draft</option>
    </select>
  </div>
    ...
    <div class="form-group">
      ...
      <select name="id_kategori" class="form-control custom-select">
        ...
        <option value="<?php echo $kategori->id_kategori ?>" <?php if($download->id_kategori==$kategori->id_kategori){echo "selected";}?> >
