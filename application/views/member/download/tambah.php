<div class="card">
  <div class="card-header">
    ...
    // Form Open
    echo form_open_multipart(base_url('member/download/tambah'),$attribut);
    ?>
<div class="card-body">
<div class="row">
<div class="col-md-8">
  ...
  <div class="form-group">
    ...
    <textarea name="deskripsi" class="form-control tinymce" placeholder="Deskripsi Download">
...
<div class="tile col-md-4">
  ...
  <div class="form-group form-group-lg">
    ...
    <input type="text" name="url_download" class="form-control" placeholder="Link Download"
    value="<?php echo set_value('url_download') ?>">
  </div>
