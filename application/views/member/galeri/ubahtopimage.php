...
$attribut = '';
// Form Open
echo form_open_multipart(base_url('member/galeri/ubahtopimage/'.$galeri->id_galeri),$attribut);
?>
...
<input type="hidden" name="posisi_galeri" class="form-control" placeholder="Judul Galeri"
value="Homepage">
