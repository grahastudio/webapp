  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        echo form_open(base_url('member/menu/edit/'.$menu->id_menu));
        ?>
        ...
        <div class="form-group form-group-lg">
          ...
          <select name="posisi" class="form-control form-control-chosen">
            ...
            <option value="Menu Bawah 1" <?php if($menu->posisi=="Menu Bawah 1"){echo "selected";}?>>Menu Bawah 1</option>
            <option value="Menu Bawah 2" <?php if($menu->posisi=="Menu Bawah 2"){echo "selected";}?>>Menu Bawah 2</option>
            <option value="Menu Bawah 3" <?php if($menu->posisi=="Menu Bawah 3"){echo "selected";}?>>Menu Bawah 3</option>
          </select>
        </div>
