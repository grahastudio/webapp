<div class="card">
  <div class="card-header">
                  ...
                  <a href="<?php echo base_url('member/berita/tambah') ?>" title="Tambah Berita baru" class="btn btn-outline-primary"><i class="fa fa-plus"></i> Tambah Berita</a>
                </div>
                </div>
...
<tr>
  ...
  <td><a class="icon" href="<?php echo base_url('member/berita/edit/' .$berita->id_berita) ?>" title="Edit Berita"><i class="fe fe-edit-3 text-primary mr-md-3"></i></a>
