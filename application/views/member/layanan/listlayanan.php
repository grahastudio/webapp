<div class="card">
  <div class="card-header">
                  ...
                  <a href="<?php echo base_url('member/layanan/tambah') ?>" title="Tambah Berita baru" class="btn btn-outline-primary"><i class="fa fa-plus"></i> Tambah Layanan</a>
                </div>
                </div>
...
<tr>
  ...
  <td><a href="<?php echo base_url('member/layanan/edit/' .$layanan->id_layanan) ?>" title="Edit Layanan" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
