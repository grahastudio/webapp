...
// Form Open
echo form_open_multipart(base_url('member/produk/tambah'),$attribut);
?>
<div class="card">
...
<div class="col-md-8">
  ...
  <div class="form-group">
    ...
    <textarea name="deskripsi" class="form-control tinymce" placeholder="Isi Produk">
...
<div class="tile col-md-4">
  ...
  <div class="form-group form-group-lg">
    ...
    value="<?php echo set_value('kode_produk') ?>">
  </div>
